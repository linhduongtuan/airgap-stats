...
# see plans/sap.md Section G. Never fixed in advance.
#
...
group_var        = "treatment"
continuous_vars   = ["age", "bmi", "egfr", "hba1c", "crp"]
categorical_vars  = ["sex", "diabetes", "hypertension", "smoking", "mortality_30day"]
